...
fig,ax=base((12,7.2))
ax.bar(x,dist,0.8,color=AZUL,zorder=3,label='DISTRIBUIÇÕES')
ax.bar(x,[-b for b in baix],0.8,color=CINZA,zorder=3,label='BAIXAS')
...
ax.set_xticks(range(10)); ax.set_xticklabels(anos,fontsize=18,color=PRETO,fontweight='bold')
...
ax.set_xticks(range(6)); ax.set_xticklabels(anos,fontsize=18); ax.set_ylim(0,100); ax.set_yticks([])
xe=2+0.5
