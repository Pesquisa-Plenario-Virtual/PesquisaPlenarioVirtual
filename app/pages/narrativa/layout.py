...
_CATALOGO = [
    GraficoSpec(
        ...
        subtitulo="Participação estável do PV ao ano (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Pauta versus concluídos (síntese do impacto) (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Só o virtual concentra a maior parte dos processos (2020–2025)",
    ...
    GraficoSpec(
        id="N4",
        rotulo="N4 — Recursos",
        subtitulo="Recursos tramitam quase inteiramente no virtual (94,3%) (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Presencial concentra mais inclusões por processo que o virtual (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Virtual conclui o que pauta em proporção muito maior que o presencial (2020–2025)",
