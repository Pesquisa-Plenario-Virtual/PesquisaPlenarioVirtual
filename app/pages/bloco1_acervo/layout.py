...
_CATALOGO = [
    ...
    ("1.c — Entrada e baixa espelhada", "Entradas e baixas anuais, escala espelhada (1988–2025).", fig_1c_distribuicao_baixa),
    ("1.d — Variação anual", "Variação anual do acervo (distribuições − baixas) (1988–2025).", fig_1d_variacao_anual),
    ("1.d.2 — Variação anual (paleta azul)", "Variação anual do acervo (entradas − baixas), decréscimo em azul (1988–2025).", fig_1d2_variacao_anual),
]
