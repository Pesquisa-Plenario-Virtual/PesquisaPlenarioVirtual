...
_CATALOGO = [
    GraficoSpec(
        ...
        subtitulo="Reajuste de voto é raro e na mesma proporção nos dois âmbitos (≈1,5%) (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Reajustes aparecem só a partir de 2020 e seguem em volume baixo (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="ADI concentra os reajustes desde o início (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="PR responde pela quase totalidade dos reajustes (2020–2025)",
    ...
    GraficoSpec(
        ...
        subtitulo="Unanimidade lidera entre as inclusões com reajuste (2020–2025)",
