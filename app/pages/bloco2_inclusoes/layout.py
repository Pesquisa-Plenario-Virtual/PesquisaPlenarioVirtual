...
_CATALOGO = [
    ...
    ("2.e — Classe por ano (PV)", "Inclusões por classe e ano no PV (2020–2025).", p.fig_2e_classe_ano_pv, p._tabela_2e),
    ("2.f — Classe por ano (PP)", "Inclusões por classe e ano no PP (2020–2025).", p.fig_2f_classe_ano_pp),
    ("2.g — Tramitação por período (2020–2025)", "Tramitação por ambiente, por período, 2020–2025.", p.fig_2g_tramitacao_periodo_2020),
    ...
    ("2.n.2 — Desfecho por categoria (PP) — %", "Desfecho por categoria e ano no PP (2020–2025), em percentual.", p.fig_2n2_categoria_ano_pp),
    ...
    ("2.n.3 — Motivos diversos por subcategoria (PP)", "Desdobramento de \"motivos diversos\" do PP em 4 subcategorias, período 2020–2025.", p.fig_2n3_motivos_diversos_pp),
    ...
    ("3.2 (alt) — Tramitação por período (2020–2025)", "Tramitação por ambiente, 2020–2025 (colunas).", p.fig_32_tramitacao_alt),
]
